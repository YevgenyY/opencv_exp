...
CFLAGS = -I /usr/local 
LDFLAGS = -lopencv_objdetect -lopencv_features2d -lopencv_imgproc -lopencv_highgui -lopencv_tracking -lopencv_videoio -lopencv_core
	        
tracker: tracker.cpp
	g++ tracker.cpp -o tracker ${CFLAGS} ${LDFLAGS} 
